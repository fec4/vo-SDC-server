...
let seedEntry = (start, max, current) => {
  if (start > max) {
    ...
    for(var i = 0; i <= 500000; i++) {
      ...
      let entry = `${generatedData.type}|${generatedData.description}|${generatedData.tags}|${generatedData.price}|${generatedData.location}|${generatedData.image}|${generatedData.rating}|${generatedData.numRatings}`;
